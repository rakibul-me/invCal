const goodColor = "#2eff6d";
const moderateColor = "#c0bd00";
const weakColor = "#ff452c";
const defaultColor = "#9acdff";
...
const indicator1 = document.getElementsByClassName("indicator1")[0];
...
function calculateLevel1(value) {
  if (value >= 15) {
    indicator1.style.backgroundColor = goodColor;
  } else if (value < 15 && value >= 5) {
    indicator1.style.backgroundColor = moderateColor;
  } else if (value < 5) {
    indicator1.style.backgroundColor = weakColor;
  } else if (value == NaN) {
    indicator1.style.backgroundColor = defaultColor;
  } else {
    indicator1.style.backgroundColor = defaultColor;
  }
}
...
const indicator2 = document.getElementsByClassName("indicator2")[0];
...
function calculateLevel2(value) {
  if (value >= 15) {
    indicator2.style.backgroundColor = goodColor;
  } else if (value < 15 && value >= 5) {
    indicator2.style.backgroundColor = moderateColor;
  } else if (value < 5) {
    indicator2.style.backgroundColor = weakColor;
  } else if (value == NaN) {
    indicator2.style.backgroundColor = defaultColor;
  } else {
    indicator2.style.backgroundColor = defaultColor;
  }
}
